...
export const fakeAlarmDescription: AlarmObj = {
  ...
  color: "#FD0E78",
  icon: "🎂",
  createAt: dayjs(new Date()).format("DD/MM/YYYY - hh: mm A"),
  toDate: dayjs(new Date()).format("DD/MM/YYYY - hh: mm A"),
